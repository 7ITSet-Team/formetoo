export default [
    {
        slug: '',
        name: 'Главная',
        title: 'Продажа жироуловителей',
        content: '<span class="jss240"><p style="text-align:center;"></p>\n' +
    ...
    },
    {
        ...
        title: 'Доставка',
        content: '<span class="jss264"><h2 style="text-align:left;"><span style="color: rgb(255,255,255);background-color: rgb(2,134,82);font-size: 22px;">Оплата товаров</span></h2>\n' +
